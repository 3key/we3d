package we3d.rasterizer 
{
	...
	/**
	* Solid colors and lighting with software rasterizer.
	*/
	public class ScanlineFlatWireLight extends RasterizerLight 
	{
		public function ScanlineFlatWireLight () {
			splitFace.vLen = 3;
		}
		
		public override function clone () :IRasterizer {
			var r:ScanlineFlatWireLight = new ScanlineFlatWireLight();
			return r;
		}
