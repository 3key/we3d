package we3d.rasterizer 
{
	...
	/**
	* Solid color with software rasterizer and zbuffer.
	*/
	public class ScanlineFlatZB extends RasterizerZBuffer 
	{
		public function ScanlineFlatZB (zb:ZBuffer=null) {
			splitFace.vLen = 3;
			zbuffer = zb;
		}
		
		public override function clone () :IRasterizer {
			var r:ScanlineFlatZB = new ScanlineFlatZB();
			r.zBuffer = zbuffer;
			return r;
		}
