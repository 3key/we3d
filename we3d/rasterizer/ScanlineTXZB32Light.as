package we3d.rasterizer 
{
	...
	*/
	public class ScanlineTXZB32Light extends RasterizerZBufferLight 
	{
		public function ScanlineTXZB32Light (zb:ZBuffer=null) {
			splitFace.vLen = 3;
			zbuffer = zb;
		}
		
		public override function clone () :IRasterizer {
			var r:ScanlineTXZB32Light = new ScanlineTXZB32Light(zbuffer);
			return r;
		}
