package we3d.rasterizer 
{
	...
	/**
	* Bitmap textures with flat lighting, software rasterizer and zbuffer.
	*/
	public class ScanlineTXZBWireLight extends RasterizerZBufferLight 
	{
		public function ScanlineTXZBWireLight (zb:ZBuffer=null) {
			splitFace.vLen = 3;
			zbuffer = zb;
		}
		
		public override function clone () :IRasterizer {
			var r:ScanlineTXZBWireLight = new ScanlineTXZBWireLight(zbuffer);
			return r;
		}
