package we3d.rasterizer 
{
	...
	/**
	 * Transparent bitmap textures with software rasterizer and lighting.
	 */
	public class ScanlineTX32Light extends RasterizerLight
	{
		public function ScanlineTX32Light () {
			splitFace.vLen = 3;
		}
		
		public override function clone () :IRasterizer {
			var r:ScanlineTX32Light = new ScanlineTX32Light();
			return r;
		}
