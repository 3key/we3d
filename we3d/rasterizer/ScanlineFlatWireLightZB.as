package we3d.rasterizer 
{
	...
	*/
	public class ScanlineFlatWireLightZB extends RasterizerZBufferLight 
	{
		public function ScanlineFlatWireLightZB (zb:ZBuffer=null) {
			splitFace.vLen = 3;
			zbuffer = zb;
		}
		
		public override function clone () :IRasterizer {
			var r:ScanlineFlatWireLightZB = new ScanlineFlatWireLightZB();
			r.zBuffer = zbuffer;
			return r;
		}
