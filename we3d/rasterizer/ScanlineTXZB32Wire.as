package we3d.rasterizer 
{
	...
	*/
	public class ScanlineTXZB32Wire extends RasterizerZBuffer 
	{
		public function ScanlineTXZB32Wire (zb:ZBuffer=null) {
			splitFace.vLen = 3;
			zbuffer = zb;
		}
		
		public override function clone () :IRasterizer {
			var r:ScanlineTXZB32Wire = new ScanlineTXZB32Wire(zbuffer);
			return r;
		}
